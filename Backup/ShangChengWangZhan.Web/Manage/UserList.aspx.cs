...
namespace Shopping.Web.Manage
{
    public partial class UserList : ManagePage
    {
        ...
        {
            GetCondition();
            datagrid.VirtualItemCount = UserBLL.GetUserCount(condition.ToString());
            datagrid.DataSource = UserBLL.GetUserList(datagrid.PageSize, datagrid.CurrentPageIndex + 1, condition.ToString());
            datagrid.DataBind();
        }
        /// <summary>
        /// 获取条件
        ...
        private string GetCondition()
        {
            ...
            if (keyword != "")
            {
                ...
                condition.AppendFormat(" UserName like '%{0}%'", keyword);
            }
        ...
        private void Delete(int Id)
        {
            ...
            bool flag = UserBLL.DeleteUser(Id);
            if (flag)
            {
                ShowOK("删除成功!");
            }
