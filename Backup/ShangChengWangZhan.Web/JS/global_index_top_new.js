...
(function (n) {
    ...
    var k = '<div class="aptab" style="left: 0px; top: 0px;"><div class="aptab_header"><ul><li class="fl pl10">温馨提示</li><li class="popwinClose fr btn_close mr10"><img src="' + imagePath + '/popwin/icon_close.jpg"></li><li class="popwinClose fr mr5 color_white"><a href="###">关闭</a></li></ul> <div class="clear"></div></div>'; k += '<div class="aptab_center" align="center"><p class="pt10">' + h + "</p>"; k += '<div align="center"><input name="submit" class="pop_win_button popwinClose" id="pop_win_ok_btn" type="button"   value="确 定" /><input name="submit"   class="pop_win_button popwinClose" type="button" id="pop_win_cancel_btn" value="返回购物车" /></div>';
...
var YHDPROVINCE = {}; YHDPROVINCE.getCurentDomain = function () { return URLPrefix.central }; YHDPROVINCE.getOppositeDomain = function () { return URLPrefix.central }; YHDPROVINCE.proviceObj = { p_1: "上海", p_2: "北京", p_3: "天津", p_4: "河北", p_5: "江苏", p_6: "浙江", p_7: "重庆", p_8: "内蒙古", p_9: "辽宁", p_10: "吉林", p_11: "黑龙江", p_12: "四川", p_13: "安徽", p_14: "福建", p_15: "江西", p_16: "山东", p_17: "河南", p_18: "湖北", p_19: "湖南", p_20: "广东", p_21: "广西", p_22: "海南", p_23: "贵州", p_24: "云南", p_25: "西藏", p_26: "陕西", p_27: "甘肃", p_28: "青海", p_29: "新疆", p_30: "宁夏", p_32: "山西" };
...
}; YHDPROVINCE.getProvinceName = function (a) { jQuery("#currentProvinceName").html("<strong>" + jQuery("#p_" + a).text() + "站</strong> >>") }; YHDPROVINCE.yhdCommonProvinceInfo = function (b, a) {
...
YHDPROVINCE.buildProvinceHtml = function () { var b = []; b.push("<dl class='hd_hot_city clearfix' data-tpc='1'>"); b.push("<dt>热门省市<i></i></dt>"); var c = jQuery("#headerAllProvince").attr("data-hot"); if (c) { var a = c.split(","); for (var f = 0; f < a.length; f++) { var g = a[f].split(":"); b.push('<dd><a data-value="' + g[0] + '" isTrkCustom="1" href="javascript:void(0);">' + g[1] + "</a></dd>") } } b.push("</dl>"); b.push("<div class='hd_province_detail clearfix' data-tpc='2'>"); for (var f = 0; f < _defaultProvinceData.length; f++) { var d = _defaultProvinceData[f].value; b.push("<dl class='clearfix'>"); b.push("<dt>" + _defaultProvinceData[f].key + "：</dt>"); for (var e = 0; e < d.length; e++) { b.push("<dd><a data-value='" + d[e].id + "'  href='javascript:;'>" + d[e].name + "</a></dd>") } b.push("</dl>") } b.push("</div>"); return b.join("") }; YHDPROVINCE.headerSelectProvince = function () {
    ...
    $.cookie("search_keyword_history", "", { domain: ".yhd.com", path: "/" }); YHDPROVINCE.yhdNoExistsProvinceInfo(f); var a = f.ipProvinceId ? f.ipProvinceId : "1"; var g = f.ipProvinceIdStr ? f.ipProvinceIdStr : "上海"; var j = -1;
...
(function (b) {
    ...
    k.registerGlobalEvent = function () {
        b("#site_header").find(".hd_search_wrap").bind("mouseleave", function () { o.hide() }); b(document).bind("click", function (u) {
            ...
            t = t || window.event; var u = t.keyCode; if (u == "116" || u == "16" || u == "17" || u == "18" || u == "38" || u == "40" || u == "13") { return } var y = w.val(); var x = w.attr("original"); if (y == "" || b.trim(y) == "" || b.trim(y) == "请输入关键词" || (b.trim(y) == x && !j)) {
...
function searchMeForBrand() { var a = jQuery("#keyword"); var b = a.val(); if (b == "" || b == "商品、品牌") { return } searchMe() } function searchMeForClick() { var a = $("#hdSearchTab"); if (a.size() > 0 && a.attr("data-type") == "2") { searchMe(null, null, null, 1); return } searchMe() } function searchInputFocus(d) {
    var c = jQuery("#keyword"); if (d) { c = jQuery(d) } if (c.size() == 0) { return } var b = c.attr("original"); var a = c.val(); var e = (typeof isSearchKeyWords != "undefined" && isSearchKeyWords == "1") ? 1 : 0; if (a == null || a == "") { if (b == null || b == "") { b = "请输入关键词"; c.attr("original", b) } c.val(b); a = b } if (!e) {
    ...
    var n = jQuery(p); if (n.length < 1) { return } var m = null; var q = jQuery("#site_header"); var t = q.css("padding-top"); if (t && t.indexOf("px") >= 0) { t = t.replace("px", "") } if (q.attr("data-hfix")) { m = q.attr("data-hfix") } var l = n.find(".index_topbanner_fold"); var v = n.find(".big_topbanner"); var s = jQuery("#smallTopBanner"); var o = typeof isWidescreen != "undefined" ? isWidescreen : false; l.click(function () {
        if ($(this).hasClass("index_topbanner_unfold")) { $(this).removeClass("index_topbanner_unfold"); $(this).html("展开<s></s>"); v.slideUp(); s.slideDown(); if (m) { q.animate({ "padding-top": t + "px" }) } } else {
            $(this).addClass("index_topbanner_unfold"); $(this).html("收起<s></s>"); v.slideDown(); s.slideUp(); if (m) {
...
YHD.HomePage.Tools.getNowTime = function () { var d; if (typeof (nowTime) == "undefined" || nowTime == undefined) { var c = new Date(); d = new Array(c.getFullYear(), c.getMonth() + 1, c.getDate(), c.getHours(), c.getMinutes(), c.getSeconds()) } else { d = nowTime.split("-") } return new Date(d[0], d[1] - 1, d[2], d[3], d[4], d[5]) }; YHD.HomePage.initIE6UpdateMsg = function () {
    var f = window.navigator.userAgent.toLowerCase(); var j = /msie ([\d.]+)/; if (j.test(f)) {
        var i = parseInt(j.exec(f)[1]); var g = $.cookie("ie6Update"); if (i <= 6 && "1" != g) {
            var h = []; h.push("<div class='ie6_upgrade clearfix' id='ie6_upgrade'>"); h.push("<div class='ie6_upgrade_wrap'>"); h.push("<span class='ie6_upgrade_sad'></span>"); h.push("<span class='ie6_upgrade_text'>温馨提示：您当前使用的浏览器版本过低，兼容性和安全性较差，1号店建议您升级：</span>"); h.push("<a href='http://windows.microsoft.com/zh-cn/internet-explorer/download-ie' target='_blank' class='ie6_upgrade_ie' tk='global_ie6_upgrade_ie8'>IE8浏览器</a>");
            h.push("<span class='ie6_upgrade_text'>或</span>"); h.push("<a href='http://chrome.360.cn/' target='_blank' class='ie6_upgrade_360' tk='global_ie6_upgrade_360'>360极速浏览器</a>"); h.push("</div>"); h.push("<a href='javascript:void(0);' class='ie6_upgrade_close' title='关闭' tk='global_ie6_upgrade_close'>关闭提示</a>"); h.push("</div>"); $(document.body).prepend(h.join("")); $("#ie6_upgrade").show(); $("#ie6_upgrade a.ie6_upgrade_close").click(function () { $("#ie6_upgrade").slideUp(); $.cookie("ie6Update", "1", { expires: 7, path: "/", domain: no3wUrl }); var a = $(this).attr("tk"); gotracker("2", a) }); $("#ie6_upgrade>div>a").click(function () { var a = $(this).attr("tk"); gotracker("2", a) })
        }
    }
}; 
...
YHD.HomePage.initPreloadAdvertise = function () {
    if ($("#preloadAdvsData").size() == 0) { return } var y = $("#preloadAdvsData").val(); var u = (y && y.length > 2) ? $.parseJSON(y) : null; var r = function () {
        ...
        var b = f == 3; var g = $("#topCurtain"); var c = a.open; var d = a.close; if (b) { if (!g.data("preloadFlag")) { g.data("preloadFlag", 1); z($(".big_topbanner", g), c); x($(".big_topbanner img", g), c); z($("#smallTopBanner", g), d); x($("#smallTopBanner img", g), d) } } else {
            ...
            e.push("</a>"); e.push("<a style='display:none;' id='smallTopBanner' class='small_topbanner' href='" + d.imgJumpLinkUrl + "' title='" + d.title + "' data-ref='" + d.perTracker + "' target='_blank'>"); e.push("<img alt='" + d.title + "' src='" + (URLPrefix.statics + "/global/images/blank.gif") + "' shortimg='" + d.imgPath + "' wideimg='" + d.imgWidePath + "'/>"); e.push("</a>"); e.push("<span title='点击-展开' class='index_topbanner_fold index_topbanner_unfold'>收起<s></s></span>"); e.push("</div>"); $("#global_top_bar").after(e.join("")); $("#topCurtain").data("preloadFlag", 1)
        }
    }; var E = function (h, b) {
