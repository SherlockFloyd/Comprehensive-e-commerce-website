...
namespace Shopping.Common
{
    ...
    public class Utils
    {
        ...
        public static void Export(StringBuilder exportData, string fileName)
        {
            StringBuilder sHtml = new StringBuilder();
            string sheetName = "sheetName";
            sHtml.Append("<html xmlns:x=\"urn:schemas-microsoft-com:office:excel\">");
            sHtml.Append("<head>");
            sHtml.Append("<!--[if gte mso 9]>");
            sHtml.Append("<xml>");
            sHtml.Append("<x:ExcelWorkCommodity>");
            sHtml.Append("<x:ExcelWorksheets>");
            sHtml.Append("<x:ExcelWorksheet>");
            sHtml.Append("<x:Name>" + sheetName + "</x:Name>");
            sHtml.Append("<x:WorksheetOptions>");
            sHtml.Append("<x:Print>");
            sHtml.Append("<x:ValidPrinterInfo />");
            sHtml.Append("</x:Print>");
            sHtml.Append("</x:WorksheetOptions>");
            sHtml.Append("</x:ExcelWorksheet>");
            sHtml.Append("</x:ExcelWorksheets>");
            ...
            HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment; filename=" + fileName + Utils.GetRandomString(4, 4, "0123456789") + ".xls");
