...
namespace Shopping.BLL
{
    ...
    public class NoticeBLL
    {
        ...
        /// 全局变量
        /// </summary>
        private static NoticeProvider DAL = NoticeProvider.GetInstance();
        ...
        /// <returns></returns>
        public static int AddNotice(Model.Notice model)
        {
        ...
        /// <param name="model">类实体</param>
        /// <returns></returns>
        public static bool UpdateNotice(Model.Notice model)
        {
        ...
        /// <returns></returns>
        public static Model.Notice GetNoticeInfo(int NoticeID)
        {
        ...
        /// <returns></returns>
        public static Model.Notice GetNoticeInfoByCondition(string condition)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<Model.Notice> GetNoticeList()
        {
        ...
        /// <returns></returns>
        public static List<Model.Notice> GetNoticeList(string condition)
        {
        ...
        /// <param name="condition">过滤条件</param>
        /// <returns></returns>
        public static List<Model.Notice> GetNoticeList(int pagesize, int pageindex, string condition)
        {
        ...
        /// <returns></returns>
        public static List<Model.Notice> GetNoticeList(int pagesize, int pageindex, string condition, string orderby, string sorttype)
        {
