...
namespace Shopping.DAL
{
    ...
    /// </summary>
    public partial class NewsProvider : SqlDB<NewsProvider>
    {
        /// <summary>
        /// 数据库表名
        /// </summary>
        private static string tableName = "Shopping_News";
        /// <summary>
        /// 数据库视图名
        /// </summary>
        ...
        /// <returns></returns>
        public int AddNotice(Model.News model)
        {
        ...
        /// <param name="model">类实体</param>
        /// <returns></returns>
        public bool UpdateNotice(Model.News model)
        {
            SqlParameter[] parameters = {
        ...
        /// 得到一个对象实体
        /// </summary>
        private Model.News GetNoticeInfo(SqlDataReader dr)
        {
        ...
        /// <returns></returns>
        public Model.News GetNoticeInfo(int NoticeID)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// <returns></returns>
        public Model.News GetNoticeInfoByCondition(string condition)
        {
            if (condition == "")
            {
                return null;
        ...
        /// </summary>
        /// <returns></returns>
        public List<Model.News> GetNoticeList()
        {
        ...
        /// <returns></returns>
        public List<Model.News> GetNoticeList(string condition)
        {
        ...
        /// <param name="condition">过滤条件</param>
        /// <returns></returns>
        public List<Model.News> GetNoticeList(int pagesize, int pageindex, string condition)
        {
            List<Model.News> list = new List<Model.News>();
        ...
        /// <returns></returns>
        public List<Model.News> GetNoticeList(int pagesize, int pageindex, string condition, string orderby, string sorttype)
        {
            List<Model.News> list = new List<Model.News>();
