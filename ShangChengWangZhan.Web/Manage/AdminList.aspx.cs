...
{
    public partial class AdminList : ManagePage
    {
        ...
        {
            GetCondition();
            datagrid.VirtualItemCount = AdminBLL.GetAdminCount(condition.ToString());
            datagrid.DataSource = AdminBLL.GetAdminList(datagrid.PageSize, datagrid.CurrentPageIndex + 1, condition.ToString());
            datagrid.DataBind();
        }
        /// <summary>
        /// 获取条件
        ...
        private string GetCondition()
        {
            ...
            if (keyword != "")
            {
                ...
                condition.AppendFormat(" AdminName like '%{0}%'", keyword);
            }
        ...
        protected void datagrid_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "del":
                    ...
                    break;
                case "resetpwd":
                    if (AdminBLL.UpdatePwd(id, "123456"))
                    {
                        ShowOK("初始化成功!");
                    }
                    else
        ...
        {
            bool flag = AdminBLL.DeleteAdmin(Id);
            if (flag)
            {
                ShowOK("删除成功!");
            }
