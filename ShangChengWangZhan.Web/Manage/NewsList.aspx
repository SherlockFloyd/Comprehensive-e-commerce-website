<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="Shopping.Web.Manage.NewsList" %>
...
<body style="height: 100%">
    ...
    <div class="grid-panel">
        <div class="grid-header" style="mozuserselect: none; khtmluserselect: none" unselectable="on">
            <img src="/icons/table.gif" />&nbsp;新闻列表</div>
        <div>
                    ...
                    <Shopping:DataGrid ID="datagrid" runat="server" PageSize="50" OnItemDataBound="datagrid_OnItemDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="操作">
                                ...
                                <ItemTemplate>
                                    <a href="NewsEdit.aspx?action=edit&id=<%# Eval("NoticeID") %>" title="编辑">
    ...
    <script type="text/javascript">
        $(function () {
            Seral.LocationHerf("NewsEdit.aspx?action=add", "add_btn");
        });
    </script>
</body>
</html>
